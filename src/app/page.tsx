  ...
  return (
    <section>
      <h1 className="mb-8 text-2xl font-semibold tracking-tighter">
        Hello world, I&apos;m Juani De los Santos
      </h1>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        ability to deconstruct complex problems into simpler, manageable parts.
        While this analytical approach has been invaluable in my career, the
        friendships I&apos;ve made along the way are what I cherish the most.
      </p>
      <p className="mb-4">
        I look forward to embracing new challenges and opportunities that drive
        innovation and foster continuous growth.
      </p>
    </section>
  );
}
